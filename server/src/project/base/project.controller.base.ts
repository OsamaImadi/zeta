  ...
  async create(@common.Body() data: ProjectCreateInput): Promise<Project> {
    return await this.service.create({
      ...
      select: {
        ...
        installationTeamName: true,
        inverterCapacity: true,
        inverterCompany: true,
        inverterSerialNumber: true,
        inverterSupplierDetails: true,
        invoiceOfPanelPurchase: true,
        netMeteringLicense: true,
        netMeteringLicenseCopyAvailable: true,
        numberOfPanels: true,
        panelsCompany: true,
        profit: true,
        projectSize: true,
        serialNumberOfPanles: true,
        startDate: true,
        structureType: true,
        totalQuotationAgreed: true,
        updatedAt: true,
        wifiDongleSerialNumber: true,
      },
    });
  }
